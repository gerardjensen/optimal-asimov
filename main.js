...
Module['FS_createPath']("/", "src", true, true);
    ...
    loadPackage({"files": [{"filename": "/src/pubs.json", "start": 0, "end": 12262}, {"filename": "/src/titles.json", "start": 12262, "end": 41654}], "remote_package_size": 41654});

  })();

// end include: /tmp/tmpmwq30gqg.js
// include: /tmp/tmpqvasncqs.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpqvasncqs.js
// include: /tmp/tmpi64124hk.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpi64124hk.js
...
var _init_solver = Module['_init_solver'] = makeInvalidEarlyAccess('_init_solver');
var _solve = Module['_solve'] = makeInvalidEarlyAccess('_solve');
var _fflush = makeInvalidEarlyAccess('_fflush');
var _delete_solver = Module['_delete_solver'] = makeInvalidEarlyAccess('_delete_solver');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['init_solver'] != 'undefined', 'missing Wasm export: init_solver');
  assert(typeof wasmExports['solve'] != 'undefined', 'missing Wasm export: solve');
  assert(typeof wasmExports['fflush'] != 'undefined', 'missing Wasm export: fflush');
  assert(typeof wasmExports['delete_solver'] != 'undefined', 'missing Wasm export: delete_solver');
  ...
  _init_solver = Module['_init_solver'] = createExportWrapper('init_solver', wasmExports['init_solver'], 0);
  _solve = Module['_solve'] = createExportWrapper('solve', wasmExports['solve'], 4);
  _fflush = createExportWrapper('fflush', wasmExports['fflush'], 1);
  _delete_solver = Module['_delete_solver'] = createExportWrapper('delete_solver', wasmExports['delete_solver'], 0);
